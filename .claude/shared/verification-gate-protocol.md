...
Secondary:  Sage verification gate (before reporting pipeline "done")
...
| Level | TaskCompleted Behavior | Sage Behavior | VCS Intercept |
|-------|----------------------|---------------|---------------|
...
## Sage Verification (Secondary Layer)

Before reporting any pipeline as "done" to the user, the Sage runs its own verification:
...
4. The Sage secondary verification runs automatically during pipeline execution
