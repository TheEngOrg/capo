...
└───────────┬───────────┘               └────────────┬────────────┘
            ...
            ▼                                        ▼
┌───────────────────────┐               ┌─────────────────────────┐
│   Dev (single spawn)  │               │  /teo-leadership-team    │
...
```
Step 1: /teo-leadership-team — Executive Review + Workstream Plan
...
Step 5: /teo-leadership-team Code Review + Approval
Step 6: /deployment-engineer merge
```

### /teo-leadership-team (Step 1)
...
| /teo-leadership-team | None | Planning + final approval |
...
```
/teo-leadership-team [describe the initiative]
```

### Request code review (ARCHITECTURAL)
```
/teo-leadership-team review workstream WS-1 on branch feature/ws-1-[name]
```
...
| teo-build | teo-leadership-team | ARCHITECTURAL | After classification | Describe initiative |
| teo-leadership-team | teo-build | ARCHITECTURAL | Workstream defined | `/teo-build execute WS-X` |
| teo-build | teo-leadership-team | ARCHITECTURAL | Workstream complete | `/teo-leadership-team review WS-X` |
| teo-leadership-team | deployment-engineer | ARCHITECTURAL | Approved | `/deployment-engineer merge` |
| teo-leadership-team | teo-build | ARCHITECTURAL | Rejected | Specific feedback |
