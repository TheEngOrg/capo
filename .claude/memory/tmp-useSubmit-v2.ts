...
// These are used when contextManager/subprocessController are not provided,
// e.g. in older tests written before M3.
...
export function useSubmit({
  ...
  subprocessController = _fallbackSubprocessController,
  ...
  }, [token_id, debug, onHistory, contextManager, subprocessController]);
}
