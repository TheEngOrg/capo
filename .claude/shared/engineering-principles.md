...
- **Skip Sage** for MECHANICAL tasks — dev handles full TDD cycle alone
- **Spawn Sage** for ARCHITECTURAL tasks and ambiguous scope
...
|-------|------|-----------|
| Sage | opus | Orchestration requires deep reasoning |
