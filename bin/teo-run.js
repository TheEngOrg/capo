...
var BaseTaskSchema = external_exports.object({
...
var ScriptTaskSchema = BaseTaskSchema.extend({
...
var SignKeyError = class extends Error {
  constructor(message) {
    super(message);
...
var KEY_BYTES = 32;
var SIG_HEX_LENGTH = 64;
var HmacSigner = class _HmacSigner {
  key;
  /**
...
function handleLedgerAppend(args) {
  const a = args;
  const baseDir = a["baseDir"];
  const ledgerOpts = {
